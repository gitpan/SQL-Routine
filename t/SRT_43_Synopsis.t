...
eval {
    ...
    t_SRT_Synopsis->populate_model( $model );
    ...
    my $expected_output = t_SRT_Synopsis->expected_model_nid_xml_output();
    ...
    my $expected_output2 = t_SRT_Synopsis->expected_model_sid_long_xml_output();
    ...
    my $expected_output3 = t_SRT_Synopsis->expected_model_sid_short_xml_output();
