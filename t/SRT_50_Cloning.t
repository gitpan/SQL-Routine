...
eval {
    ...
    t_SRT_Util->message( q{NID: First build populated Container object from an original model's NID dump...} );
    ...
    t_SRT_Util->message( q{SID-L: First build populated Container object from an original model's SID-long dump...} );
    ...
    t_SRT_Util->message( q{SID-S: First build populated Container object from an original model's SID-long dump...} );
