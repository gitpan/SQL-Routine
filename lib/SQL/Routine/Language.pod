...
Attribute List:
	...
	name - L.cstr - MA - the name this scalar data type is identified by
...
Attribute List:
	...
	value - L.misc - MA - this is the actual enumerated value that the scalar_data_type_opt Node represents
...
Attribute List:
	...
	id - NODE_ID - unique identifier for each Node within this Node Type
	name - L.cstr - MA - the name this row data type is identified by
...
Attribute List:
	...
	name - L.cstr - MA - unique identifier for this field within the row
...
Attribute List:
	...
	id - NODE_ID - unique identifier for each Node within this Node Type
	name - L.cstr - MA - lets you label the blueprint if you want; this isn't used when making SQL
...
Attribute List:
	...
	id - NODE_ID - unique identifier for each Node within this Node Type
	name - L.cstr - MA - lets you label the blueprint if you want
...
Attribute List:
	...
	name - L.cstr - MA - the name this domain is identified by
...
Attribute List:
	...
	row_field - N.row_data_type_field - MA - defines the name and type of this column
...
Attribute List:
	...
	field - N.row_data_type_field - MA - unique identifier for column within table
...
The difference between correlated vs un- is analagous to a routine that takes
...
Attribute List:
	...
	id - NODE_ID - unique identifier for each Node within this Node Type
	pp_src - N.view_src - PP - which view source this column is associated with
	match_field - N.row_data_type_field - MA - which field from the source table/view/var is represented
...
Attribute List:
	...
	name - L.cstr - MA - name routine ident by in a [schema, pp_routine, app], or name of trigger
...
Attribute List:
	...
	id - NODE_ID - unique identifier for each Node within this Node Type
	name - L.cstr - MA - lets you label the product in the model if you want
...
Attribute List:
	...
	id - NODE_ID - unique identifier for each Node within this Node Type
	name - L.cstr - MA - lets you label the instance if you want; this isn't used when making SQL
...
Attribute List:
	...
	id - NODE_ID - unique identifier for each Node within this Node Type
	name - L.cstr - MA - lets you label the instance if you want
...
Exclusive Attribute Groups List:
	...
	link_root_unrealized - pp_link,unrealized - MA
